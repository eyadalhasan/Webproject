...
<div class="container">
    <div class="row justify-content-center">
        <div class="form">
            <div class="title">
                <h2 style="color: white;"> <i class="fas fa-bars mt-3" ></i> Categories </h2>
            </div>
            <hr>
            <div>
                <div class="text-left">
                    <label class="font-weight-bold" style="color: white;">  Count Of Categories :
                        <span id="count_of_categories"><?php include getUrl('php/functions/categories/controller.php?operation_type=count'); ?></span>
                    </label>
                    <br/>
                    <a href="#" id="btn_add_new_product" data-target="#modal_category" data-toggle="modal" class="text-primary"> <i class="fas fa-plus"></i> Add New Category </a>
                </div>
                <hr>
                ...
                <div>
                    <table class="table table-bordered">
                        ...
                        <tbody id="table_categories">
                            <?php include('../php/functions/categories/showAll.php' ); ?>
                        </tbody>
                    </table>
                </div>
            </div>
...
<script src="<?php url('js/dashboard/categories.js') ?>"></script>
<script src="<?php url('js/categories/category_class.js') ?>"></script>
</body>
</html>